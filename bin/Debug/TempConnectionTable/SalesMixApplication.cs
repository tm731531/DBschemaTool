...
{
public class SalesMixApplication
{
        ///<summary> 
        /// 主鍵 
        /// </summary> 
        ...
        ///<summary> 
        /// 商品文件申請類別， 0: 新商品提報,1:修改商品 (不含:成本及分期設定)**停用**, 2:修改商品 (含: 成本及分期設定)**停用**, 3:B2E主管修改商品(無變價功能)**停用**, 4:(停用)B2E營業主管商品變價, 5:B2B修改商品(無變價功能), 6:B2B商品變價,7:B2B商品變量,8:營業主管變量,9:B2B修改商品銷售狀態,10:帶狀變價(JOB自動產生),11:B2E維護商品,12:B2E維護大批商品13:賣貴通報23影音,29:B2E營業主管商品變價,30:B2E商開商品變價 
        /// </summary> 
        [Column("salesMixType")] 
        ...
        ///<summary> 
        /// 富購商品類型,富購一般商品,國內外旅遊商品, 1001:一般商品,1005:國內旅遊商品,1006:國外旅遊商品 (依環境有所區別) 
        /// </summary> 
        [Column("fugoItemType")] 
        [MaxLength(4)] 
        ...
        ///<summary> 
        /// =backendcategory.shoppingPointUpperBound 
        /// </summary> 
